...
class ECG2PPGpsThenLSTM(nn.Module):
    def __init__(self, in_channels=1, out_channels=1):
        ...
        self.lstm = nn.LSTM(input_size=24, hidden_size=24, num_layers=1, batch_first=True, bidirectional=False)
        self.lstm_out = nn.Conv1d(24, out_channels, kernel_size=15, padding='same')
    ...
    def forward(self, x):
        ...
        x = x.permute(0, 2, 1)  # -> [batch, channels, time] for Conv1d
